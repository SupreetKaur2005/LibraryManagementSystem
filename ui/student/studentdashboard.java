...
public class StudentDashboard extends JFrame {
    ...
    public StudentDashboard() {
        ...
        mainPanel.add(new BorrowBookPanel(), "BorrowBooks");
        mainPanel.add(new ReturnBookPanel(), "ReturnBooks");
        mainPanel.add(new StatusPanel(), "ViewStatus");
        mainPanel.add(new RequestBookPanel(), "RequestBook");
        mainPanel.add(new BorrowBookPanel(), "ReissueBooks"); // Temporary (Reuse Borrow panel)
