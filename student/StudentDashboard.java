...
public class StudentDashboard extends JPanel {
    ...
    public StudentDashboard(MainFrame parentFrame) {
        ...
        buttonsPanel.add(viewStatusButton);
        ...
        // Button Listeners
        notificationButton.addActionListener(e -> parentFrame.openPanel(new NotificationPanel(parentFrame)));
        requestBookButton.addActionListener(e -> parentFrame.openPanel(new RequestBookPanel(parentFrame)));
        returnBookButton.addActionListener(e -> parentFrame.openPanel(new ReturnBookPanel(parentFrame)));
        viewStatusButton.addActionListener(e -> parentFrame.openPanel(new StatusPanel(parentFrame)));
    }
}